...
import com.example.alarm.models.Caretaker;
import com.example.alarm.ui.home.CaretakerHomeFragment;
...
public class RegisterCaretaker extends AppCompatActivity {
    ...
    Button btnSubmit;
    com.example.alarm.models.Caretaker caretaker;
    FirebaseAuth auth;
    ...
    void init(){
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RegisterCaretaker.this, com.example.alarm.Caretaker.class);
