...
public class GlucoseReading extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(GlucoseReading.this,MenuPatient.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(1,501,1,"Edit Medical Information").setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==301){
            Log.i("Info3","103");
            Intent intent=new Intent(GlucoseReading.this,DocDept.class);
            startActivity(intent);
        }
        if(item.getItemId()==401){
            Log.i("Info4","104");
            Intent intent=new Intent(GlucoseReading.this,MedicalDetails.class);
            startActivity(intent);
        }
        ...
        if(item.getItemId()==601){
            Log.i("Info5","105");
            Intent intent=new Intent(GlucoseReading.this,LoginPatient.class);
            startActivity(intent);
        }
